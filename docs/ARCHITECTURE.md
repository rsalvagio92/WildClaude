...
│  │  Haiku +     │  │  5 lanes,   │  │  + internal        │ │
│  │  budget-     │  │  debate +   │  │  sentinels for     │ │
│  │  aware)      │  │  workflows) │  │  reflection/       │ │
│  │              │  │             │  │  digest/budget)    │ │
│  └──────┬───────┘  └──────┬──────┘  └────────┬───────────┘ │
│         │                 │                   │              │
│  ┌──────▼─────────────────▼───────────────────▼───────────┐ │
...
│  │ (FTS5 +  │ │ (sandbox │ │ Self-mod │ │ PIN+audit     │ │
│  │ blocks + │ │ -isolated│ │          │ │               │ │
│  │ embed)   │ │  )       │ │          │ │               │ │
│  └──────────┘ └──────────┘ └──────────┘ └───────────────┘ │
│                                                              │
│  ┌─────────── HERMES STACK ──────────────────────────────┐ │
│  │ Sandbox (3 backends)    │  Auto-skill synthesis        │ │
│  │ execute_code (vm+wc)    │  Agent self-improvement      │ │
│  │ Trace Inspector         │  Workflows (DAG)             │ │
│  │ TokenJuice              │  Evals                       │ │
│  │ Cost Budget             │  Debate                      │ │
│  │ Reflection / Digest     │  Moods                       │ │
│  │ Fine-tune pipeline      │  Plugin SDK + Litestream     │ │
│  └────────────────────────────────────────────────────────┘ │
│                                                              │
│  ┌─────────── MCP TOOLS ────────────────────────────────┐ │
